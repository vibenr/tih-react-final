  ...
  <form className="w-full max-w-lg mt-14" action={`/addform/${formname}`} method="post" enctype="multipart/form-data">
        ...
        <div className="flex flex-wrap -mx-3 mb-2">
                <div className="w-full md:w-full px-3 mb-6 md:mb-0">
                    ...
                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200  rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="file" name="file" type="file"/>
                </div>
        </div>
